...
METER = "4/4"  # Change this to match your melody's time signature

# ============================================================================
# TEST MELODY: "She's Always a Woman" (Billy Joel)
# Extracted from shes-always-a-woman-voice.mid (90 notes)
# Format: (MIDI pitch, duration in beats)
# ============================================================================

TEST_MELODY = [
    (58, 0.25), (58, 0.25), (58, 0.25), (53, 0.25), (58, 0.25), (60, 0.25), (58, 0.25), (53, 0.25), (65, 0.25), (65, 0.25),
    (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25), (67, 1.0), (65, 0.25), (63, 0.25), (53, 0.25), (65, 0.5), (67, 0.5),
    (70, 0.5), (58, 0.25), (67, 0.75), (65, 0.25), (63, 0.5), (63, 0.5), (70, 0.25), (70, 0.25), (70, 0.5), (72, 0.5),
    (75, 0.5), (51, 0.25), (72, 0.5), (70, 0.5), (68, 0.5), (55, 0.25), (70, 0.5), (72, 0.5), (75, 0.5), (51, 0.25),
    (72, 1.5), (55, 0.25), (65, 0.5), (65, 0.5), (53, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25), (67, 0.5),
    (65, 0.5), (63, 0.5), (53, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (62, 0.25), (67, 1.5), (65, 0.5), (55, 0.25),
    (65, 0.5), (63, 0.5), (67, 0.5), (55, 0.25), (65, 0.5), (63, 0.5), (67, 0.5), (51, 0.25), (65, 0.5), (63, 0.5),
    (67, 0.5), (53, 0.25), (65, 0.5), (63, 0.5), (62, 0.5), (58, 0.25), (63, 3.0), (58, 0.25), (58, 0.25), (65, 0.25),
    (65, 0.25), (53, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25), (67, 1.0), (65, 0.25), (63, 0.25), (53, 0.25),
    (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25), (67, 0.5), (63, 1.0), (70, 0.25), (70, 0.25), (70, 0.5), (72, 0.5),
    (75, 0.5), (51, 0.25), (72, 0.5), (70, 0.5), (68, 0.5), (60, 0.25), (70, 0.5), (72, 0.5), (75, 0.5), (53, 0.25),
    (72, 0.5), (51, 0.25), (70, 1.0), (65, 0.25), (53, 0.25), (65, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25),
    (67, 0.5), (65, 0.5), (63, 0.5), (56, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (62, 0.25), (67, 1.5), (65, 0.25),
    (65, 0.25), (55, 0.25), (65, 0.5), (63, 0.5), (67, 0.5), (55, 0.25), (65, 0.5), (63, 0.5), (67, 0.5), (51, 0.25),
    (65, 0.5), (63, 0.75), (67, 0.25), (53, 0.25), (65, 0.5), (63, 0.75), (62, 0.25), (58, 0.25), (63, 3.0), (56, 0.25),
    (58, 0.25), (58, 0.25), (55, 0.25), (75, 3.0), (55, 0.25), (53, 0.25), (75, 0.5), (72, 0.5), (74, 0.5), (60, 0.25),
    (75, 0.5), (77, 0.5), (72, 0.5), (53, 0.25), (75, 3.0), (53, 0.25), (53, 0.25), (75, 0.5), (72, 0.5), (74, 0.5),
    (53, 0.25), (75, 0.5), (77, 0.5), (70, 0.5), (51, 0.25), (72, 3.0), (63, 0.25), (60, 0.25), (68, 0.5), (70, 0.5),
    (53, 0.25), (72, 0.5), (70, 0.5), (68, 0.5), (58, 0.25), (70, 3.0), (58, 0.25), (58, 0.25), (70, 1.5), (58, 0.25),
    (78, 3.0), (58, 0.25), (56, 0.25), (78, 0.5), (75, 0.5), (77, 0.5), (51, 0.25), (78, 0.5), (80, 0.5), (75, 0.5),
    (56, 0.25), (77, 3.0), (56, 0.25), (54, 0.25), (77, 0.5), (73, 0.5), (75, 0.5), (61, 0.25), (77, 0.5), (78, 0.5),
    (73, 0.5), (54, 0.25), (75, 3.0), (54, 0.25), (54, 0.25), (72, 0.5), (74, 0.5), (51, 0.25), (75, 0.5), (74, 0.5),
    (72, 0.5), (53, 0.25), (70, 3.0), (55, 0.25), (56, 0.25), (65, 0.25), (65, 0.25), (65, 0.5), (67, 0.5), (70, 0.5),
    (58, 0.25), (67, 1.0), (65, 0.25), (63, 0.25), (56, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25), (67, 0.5),
    (63, 1.0), (61, 0.25), (70, 0.25), (70, 0.25), (70, 0.5), (72, 0.5), (75, 0.5), (51, 0.25), (72, 0.5), (70, 0.5),
    (68, 0.5), (55, 0.25), (70, 0.5), (72, 0.5), (75, 0.5), (53, 0.25), (72, 0.5), (70, 1.0), (54, 0.25), (65, 0.25),
    (56, 0.25), (65, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25), (67, 0.5), (65, 0.5), (63, 0.5), (53, 0.25),
    (65, 0.5), (67, 0.5), (70, 0.5), (62, 0.25), (67, 1.5), (65, 0.25), (65, 0.25), (55, 0.25), (65, 0.5), (63, 0.5),
    (67, 0.5), (55, 0.25), (65, 0.5), (63, 0.5), (67, 0.5), (51, 0.25), (65, 0.5), (63, 0.75), (67, 0.25), (53, 0.25),
    (65, 0.5), (63, 0.75), (62, 0.25), (58, 0.25), (63, 3.0), (58, 0.25), (58, 0.25), (63, 0.5), (53, 0.25), (65, 0.5),
    (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25), (67, 1.0), (65, 0.5), (53, 0.25), (65, 0.5), (67, 0.5), (70, 0.5),
    (62, 0.25), (67, 1.5), (67, 1.0), (67, 0.5), (55, 0.25), (72, 0.5), (70, 0.5), (67, 0.5), (55, 0.25), (72, 0.5),
    (70, 0.5), (67, 0.5), (53, 0.25), (65, 0.5), (63, 0.5), (67, 0.5), (53, 0.25), (65, 0.5), (63, 0.5), (62, 0.5),
    (58, 0.25), (63, 3.0), (58, 0.25), (58, 0.25), (65, 0.25), (55, 0.25), (72, 0.5), (70, 0.5), (70, 0.5), (55, 0.25),
    (70, 0.5), (70, 0.5), (75, 0.5), (51, 0.25), (72, 0.5), (70, 0.5), (67, 0.5), (51, 0.25), (65, 0.5), (63, 0.5),
    (67, 0.5), (60, 0.25), (65, 0.5), (63, 0.5), (67, 0.5), (56, 0.25), (65, 0.5), (63, 0.5), (62, 0.5), (58, 0.25),
    (63, 3.0), (58, 0.25), (58, 0.25), (63, 0.5), (65, 0.5), (53, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (58, 0.25),
    (67, 1.0), (65, 0.5), (53, 0.25), (65, 0.5), (67, 0.5), (70, 0.5), (62, 0.25), (67, 1.5), (67, 1.0), (67, 0.5),
    (55, 0.25), (72, 0.5), (70, 0.5), (67, 0.5), (55, 0.25), (72, 0.5), (70, 0.5), (67, 0.5), (53, 0.25), (65, 0.5),
    (63, 0.5), (67, 0.5), (53, 0.25), (65, 0.5), (63, 0.5), (62, 0.5), (58, 0.25), (63, 3.0),  # 400 notes extracted from Billy Joel MusicXML
]
